...
import 'package:email_snaarp/presentation/auth/start_screen.dart';
        ...
        switch (settings.name) {
          case '/':
            return CupertinoPageRoute(
              builder: (builderContext) => StartScreen(
                onGetStarted: () {
                  Navigator.pushReplacementNamed(
                    builderContext,
                    authState ? '/inbox' : '/login',
                  );
                },
              ),
            );
          ...
          case '/inbox':
            return CupertinoPageRoute(builder: (_) => const InboxScreen());
          case '/email_detail':
            final args = settings.arguments as String?;
            return CupertinoPageRoute(
                builder: (_) => EmailDetailScreen(emailId: args!));
          default:
            return CupertinoPageRoute(
